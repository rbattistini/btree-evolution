...
[#best-fitness-candle]
.Grafico a candela della miglior fitness ottenuta in ciascuno dei tre esperimenti in analisi, a confronto con i risultati ottenuti impiegando un albero per il movimento casuale e due alberi sviluppati manualmente.
...
[#btree-evolved-grid5]
[example]
.Rappresentazione testuale dell'albero relativo all'esperimento `lucid_liskov`.
----
└── Selector
    ├── Sequence
    │   ├── moveForward
...
[#btree-evolved-grid7]
.Rappresentazione testuale dell'albero relativo all'esperimento `inspiring_sanderson`.
[example]
----
└── Sequence
    └── Selector
...
[#btree-evolved-grid9]
.Rappresentazione testuale dell'albero relativo all'esperimento `wonderful_thompson`.
[example]
----
└── Selector
    ├── Sequence
